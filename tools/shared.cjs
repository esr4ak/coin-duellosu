...
return {LISTING,STABLE,FALLBACK,DATA_DATE,DAILY_SYMBOLS,VERSION,dayKey,rnd,dailyPool,dailySymbols,dailyMatches,nextSeriesAt,hardestRound,utm,coinURL,normalizeMarkets};
});
